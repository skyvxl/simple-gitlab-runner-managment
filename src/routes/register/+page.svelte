...
<div
  class="m3-surface-container-lowest"
  style="min-height: 100vh; display: flex; align-items: center; justify-content: center; padding: 24px;"
>
  <div
    class="m3-card"
    style="width: 100%; max-width: 400px; padding: 32px; border-radius: 16px; background: rgb(var(--m3-scheme-surface-container-low));"
  >
    <h1
      class="m3-headline-medium"
      style="text-align: center; margin-bottom: 24px; color: rgb(var(--m3-scheme-on-surface));"
    >
      Register
    </h1>
    <form
    ...
    >
      ...
      <div
        class="m3-body-small"
        style="color: rgb(var(--m3-scheme-on-surface-variant)); margin-top: 8px; text-align: center;"
      >
